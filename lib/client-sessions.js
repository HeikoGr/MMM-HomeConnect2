...
/*
 * Clients of the shared session: the first CONFIGURE opens it (owner config),
 * later ones are compared against it - different credentials are rejected,
 * other differences only logged - and get the running state.
 *
...
const { findCredentialMismatchKeys, findIgnoredSessionKeys, resolveSessionLanguage } = require("./session-config");
