...
const { deviceAppearsActive, getDeviceTypeMeta, isDeviceConnected } = require("./device-utils");

const INITIAL_SETTINGS_DEVICE_TYPES = new Set(["Hood"]);
...
class DeviceService {
  ...
  shouldFetchInitialSettings(device) {
    ...
    return INITIAL_SETTINGS_DEVICE_TYPES.has(canonicalType);
  }
