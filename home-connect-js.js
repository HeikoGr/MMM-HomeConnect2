...
const getClient = function (accessToken) {
...
function refreshToken (clientSecret, refreshToken) {
  return new Promise((resolve, reject) => {
    ...
    fetch(`${isSimulated
      ? urls.simulation.base
      : urls.physical.base}security/oauth/token`, {
      method: "POST",
...
class HomeConnect extends EventEmitter {
  ...
  async init (options) {
    global.isSimulated = options != undefined && "isSimulated" in options && typeof options.isSimulated === "boolean"
      ? options.isSimulated
      : false;
